...
@section('title', 'سياسة الخصوصيه')

@section('content')
    <div class="privacyContent container" style="padding-top: 100px;direction: ltr">
        <h2 class="">privacy policy</h2>
        <div class="contant">
            <h4>Updated at September 19th, 2023</h4>
            <article>
                courza is committed to protecting your privacy. This Privacy Policy
                explains how your personal information is collected, used, and
                disclosed by courza. This Privacy Policy applies to our website, and
                its associated subdomains (collectively, our “Service”) alongside our
                application, courza. By accessing or using our Service, you signify
            ...
            <ul>
                ...
                <li>
                    ...
                    it refers to courza, (egypt), that is responsible for your
                    information under this Privacy Policy.
                </li>
                <li>
                    Country: where courza or the owners/founders of courza are based, in
                    this case is egypt
                </li>
                <li>
                    Customer: refers to the company, organization or person that signs
                    up to use the courza Service to manage the relationships with your
                    consumers or service users.
                </li>
                <li>
                    Device: any internet connected device such as a phone, tablet,
                    computer or any other device that can be used to visit courza and
                    use the services.
                </li>
                <li>
                ...
                <li>
                    Personnel: refers to those individuals who are employed by courza or
                ...
                <li>
                    Service: refers to the service provided by courza as described in
                ...
                <li>
                    Website: courza’s site, which can be accessed via this URL:
                    courza.net
                </li>
                <li>
                    You: a person or entity that is registered with courza to use the
                    Services.
                </li>
            </ul>
            ...
            <article>
                ...
                fraud prevention and diagnostic purposes. We automatically collect
                ...
                contact information) but may include device and usage information,
            ...
            <h2>Personnel</h2>
            <p>
                If you are a courza worker or applicant, we collect information you
            ...
            <p>
                ...
                of the assets of courza or any of its Corporate Affiliates (as defined
                herein), or that portion of courza or any of its Corporate Affiliates
            ...
            <p>
                ...
                courza, whether by ownership or otherwise. Any information relating to
            ...
            <h2>Governing Law</h2>
            <article>
                This Privacy Policy is governed by the laws of egypt without regard to
                ...
                under Privacy Shield, or the Swiss-US framework. The laws of egypt,
                excluding its conflicts of law rules, shall govern this Agreement and
                your use of the website. Your use of the website may also be subject
                to other local, state, national, or international laws. By using
                courza or contacting us directly, you signify your acceptance of this
            ...
            <p>
                ...
                it's being used. By using our courza, registering an account, or
            ...
            <article>
                ...
                contain links to other websites not operated or controlled by courza.
            ...
            <h2>Cookies</h2>
            <article>
                courza uses "Cookies" to identify the areas of our website that you
            ...
            <article>
                ...
                not page 4/6 be able to fully utilize all of its features and
            ...
            <article> In respect to any credit card or other payment processing details you have provided us, we commit that
                this
                confidential information will be stored in the most secure manner possible.</article>
            <h2>Kids' Privacy
            </h2>
            <article>We collect information from kids under the age of 13 just to better our services. If You are a parent
                or
            ...
            <article>We may change our Service and policies, and we may need to make changes to this Privacy Policy so that
                ...
                your account.</article>
            <h2>Third-Party Services</h2>
            <article>We may display, include or make available third-party content (including data, information,
                applications and
                other products services) or provide links to third-party websites or services ("Third- Party Services").
                You acknowledge and agree that courza shall not be responsible for any Third-Party Services, including their
                accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other
                aspect thereof. courza does not assume and shall not have any liability or responsibility to you or any
                other
            ...
            <p>Don't hesitate to contact us if you have any questions.
                ● Via Email: yossefadel713@gmail.com</p>
        </div>
    </div>
@endsection
